...
각 항목은 20개의 영상들의 예시와 데이터에 기반한 구체적인 수치를 포함해서 내용을 쉽게 풀어서 설명해주세요."""
    ...
    def run(self):
        ...
        if not self.keyword:  # 키워드가 입력되지 않았을 때 소개 페이지 표시
            ...
            # 섹션 1: 소개
            st.header("👋 콘텐츠 기획 아이디어는 어디서?!")
            st.markdown("""
            안녕하세요. 피부과 인하우스 마케텅 태팀장입니다. 저는 기획을 할 때 유튜브에서 인사이트를 얻는 편인데요.
            시청자 참여도가 높은 콘텐츠와 시청자들의 댓글에서 키워드를 추출하는 방식으로 작업해왔습니다.
